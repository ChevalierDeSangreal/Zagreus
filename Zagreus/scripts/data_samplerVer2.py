...
"""
Based on data_sampler.py
sample multiple times
every time, begin position control after 5s
use trajectory.setpoint.position.00/01 != 0 to beging
"""
...
async def run():
    """ 启动 PX4 SITL 并执行轨迹采集 """
    px4_dir = os.path.expanduser("~/Downloads/PX4-Autopilot")
