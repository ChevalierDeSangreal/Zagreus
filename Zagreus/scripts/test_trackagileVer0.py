...
from Zagreus.utils import velh_lossVer5, agile_lossVer1, AgileLoss, agile_lossVer4
...
"""
Bsed on test_main_trackagile_wholeVer11.py
...
def get_args():
	custom_parameters = [
		...
		{"name": "--experiment_name", "type": str, "default": "test_transferVer0", "help": "Name of the experiment to run or load."},
